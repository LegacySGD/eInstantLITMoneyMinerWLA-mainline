...
public class LITMoneyMinerWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITMoneyMinerWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITMoneyMinerWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITMoneyMinerWLAIW/InitOutcome.xml").getDocumentElement();
